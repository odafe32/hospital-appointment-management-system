...
<head>
	...
	<!-- Page Title -->
	<title>About Us | MediPro - Hospital  Management</title>
	<!-- Favicon Icon -->
				...
				<div class="container">
					...
					<div class="header-logo">
						<a class="navbar-brand" href="">
							<img src="assets/assets/assets/images/logo.svg" alt="">
						</a>
					</div>
					<!-- Logo End -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="page-about-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3">Caring For The Health & Well Being Of Family.</h2>
                        </div>
                        <!-- Section Title End -->

                        <!-- Page About Body Start -->
                        <div class="page-about-body">
                            <p class=" wow fadeInUp">Our family-centered approach to healthcare ensures that each member of your family receives personalized attention and care tailored to their unique needs. We believe in building strong relationships with our patients, fostering trust.</p>
                        </div>
                        <!-- Page About Body End -->

                        <!-- Page About Footer Start -->
                        <div class="page-about-footer wow fadeInUp" data-wow-delay="0.25s">
                            <!-- About Footer Image Start -->
                            <div class="about-footer-img">
                                <figure class="image-anime">
                                    <img src="assets/images/about-footer-img.jpg" alt="">
                                </figure>
                            </div>
                            <!-- About Footer Image End -->

                            <!-- About Footer Content Start -->
                            <div class="about-footer-content">
                                <div class="footer-content-title">
                                    <h3>dr. elizabeth foster</h3>
						...
						<div class="page-about-image">
							<div class="page-about-image-1">
								<figure class="image-anime reveal">
									<img src="assets/images/page-about-us-img-1.jpg" alt="">
								</figure>
							</div>

							<div class="page-about-image-2">
								<figure class="image-anime reveal">
									<img src="assets/images/page-about-us-img-2.jpg" alt="">
								</figure>
							</div>
						</div>
						<!-- About Image End -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="improving-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3">Improving The Quality Of Your Life Through Better Health.</h2>
                        </div>
                        <!-- Section Title End -->

                        <!-- Improving Body Start -->
                        <div class="improving-body">
                            <p class="wow fadeInUp">we offer a wide range of comprehensive healthcare services to address all aspects of your health. From preventive care and health screenings to specialized treatments and chronic disease management.</p>
                        </div>
                        <!-- Improving Body End -->

                        <!-- Improving Btn Start -->
                        <div class="improving-btn wow fadeInUp" data-wow-delay="0.25s">
                            <a href="https://www.youtube.com/watch?v=Y-x0efG1seA" class="btn-video popup-youtube"><i class="fas fa-play-circle"></i> Play Video</a>
                        </div>
                        <!-- Improving Btn End -->
                    </div>
        ...
        <div class="container">
            <div class="row section-row">
                <div class="col-lg-5 col-md-12">
                    <!-- Section Title Start -->
                    <div class="section-title">
                        <h3 class="wow fadeInUp">top services</h3>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="services-item wow fadeInUp">
                        <div class="services-img">
                            ...
                            <img class="services-icon-white" src="assets/images/icon-service-white-1.svg" alt="">
                        </div>
                        <div class="services-content">
                            <h3>modern laboratory</h3>
                            <p>Our laboratory is equipped with the latest diagnostic equipment and automation systems, ensuring precise.</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <!-- Services Item Start -->
                    <div class="services-item wow fadeInUp" data-wow-delay="0.25s">
                        <div class="services-img">
                            <img src="assets/images/icon-service-2.svg" alt="">
                            <img class="services-icon-white" src="assets/images/icon-service-white-2.svg" alt="">
                        </div>
                        <div class="services-content">
                            <h3>diagnostics center</h3>
                            <p>We are committed to providing exceptional laboratory services, supporting healthcare providers .</p>
                        </div>
                        <div class="services-btn">
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="services-item wow fadeInUp" data-wow-delay="0.5s">
                        <div class="services-img">
                            ...
                            <img class="services-icon-white" src="assets/images/icon-service-white-3.svg" alt="">
                        </div>
                        <div class="services-content">
                            <h3>eperienced doctors</h3>
                            <p>we take pride in our team of experienced doctors who are at the forefront of delivering exceptional.</p>
                        </div>
                        <div class="services-btn">
        ...
        <div class="container">
            <div class="row section-row">
                <div class="col-lg-10 col-md-12">
                    <!-- Section Title Start -->
                    <div class="section-title">
                        <h3 class="wow fadeInUp">caring for the health of you and your family.</h3>
                        <h2 class="text-anime-style-3">We Provide All Aspects Of Medical Practice For Your Whole Family!</h2>
                    </div>
                    <!-- Section Title End -->
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="health-services-content">
                        <h2 class="wow fadeInUp">Welcome to medipro, where we offer comprehensive medical care tailored to every member of your family.</h2>
                        <p class="wow fadeInUp" data-wow-delay="0.25s">Our dedicated team of healthcare professionals is committed to providing you and your loved ones with personalized and compassionate healthcare services. We understand the importance of family health.</p>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="health-service-info">
                        ...
                        <div class="health-service-item wow fadeInUp">
                            <div class="icon-box">
                                <img src="assets/images/icon-health-service.svg" alt="">
                            </div>
                            <div class="health-info-content">
                                <h3>patient information</h3>
                                <p>I hereby give consent to and its healthcare professionals to provide medical treatment.</p>
                            </div>
                        </div>
                        <!-- health Services Item Start  -->
                        ...
                        <div class="health-service-item wow fadeInUp" data-wow-delay="0.25s">
                            ...
                            <div class="health-info-content">
                                ...
                                <p>This application form is for informational purposes only and does not guarantee.</p>
                            </div>
                        </div>
                        <!-- health Services Item Start  -->

                        <!-- health Services Item End  -->
                        <div class="health-service-item wow fadeInUp" data-wow-delay="0.5s">
                            <div class="icon-box">
                                <img src="assets/images/icon-health-service.svg" alt="">
                            </div>
                            <div class="health-info-content">
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-lg-4">
					<!-- Cta Btn Start -->
					<div class="cta-btn">
						<a href="signin.php" class="appointment-btn wow fadeInUp">make appointment <i class="fa-solid fa-calendar-days"></i></a>
					</div>
					<!-- Cta Btn End -->
				</div>
			</div>
            ...
            <div class="row section-row">
                <div class="col-lg-12">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3">What Patients Say About Us.</h2>
                    </div>
                    <!-- Section Title End -->
                </div>
            </div>
