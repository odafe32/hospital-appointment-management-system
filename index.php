...
<head>
	...
	<!-- Page Title -->
	<title>MediPro - Hospital  Management</title>
	<!-- Favicon Icon -->
				...
				<div class="col-lg-6">
					...
					<div class="hero-content">
						...
						<div class="section-title">
                            <h3 class="wow fadeInUp">we tack care of your health</h3>
                            <h1 class="text-anime-style-3">We Are Providing Best & Affordable Health Care.</h1>
                        </div>
						<!-- Section Title End -->

						<!-- Hero Body Start -->
						<div class="hero-body">
							<p class="wow fadeInUp">our is to deliver the highest quality healthcare services. We believe that everyone deserves access to excellent medical care without compromising on quality.</p>
						</div>
						<!-- Hero Body End -->

						<!-- Hero Footer Start -->
						<div class="hero-footer">
							<a href="#" class="btn-default wow fadeInUp" data-wow-delay="0.25s">read more</a>
                            <a href="https://www.youtube.com/watch?v=Y-x0efG1seA" class="btn-video popup-youtube wow fadeInUp" data-wow-delay="0.25s"><i class="fas fa-play-circle"></i> Watch Video</a>
						</div>
						<!-- Hero Footer Start -->
					</div>
					<!-- Hero Content Start -->
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					...
					<div class="home-contact-item highlighted-box wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="appointment-wrap">
                            <a class="appointment-btn" href="signin.php">make appointment <i class="far fa-calendar-alt"></i> </a>
                        </div>
                    </div>
					<!-- Home Contact End -->
				</div>
				...
				<div class="col-lg-4 col-md-4">
					...
					<div class="home-contact-item box-border wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="contact-icon">
                            <img src="assets/images/icon-home-contact-1.svg" alt="">
                        </div>
						<!-- Contact Icon End -->
				...
				<div class="col-lg-4 col-md-4">
					...
					<div class="home-contact-item wow fadeInUp" data-wow-delay="0.25s">
						<!-- contact Icon Start -->
                        <div class="contact-icon">
                            <img src="assets/images/icon-home-contact-2.svg" alt="">
                        </div>
						<!-- Contact Icon End -->
			...
			<div class="row align-items-center">
					...
					<div class="about-img">						
						...
						<div class="about-video wow fadeInUp">
							<figure class="image-anime">
								<img src="assets/images/about-video-img.jpg" alt="">
								<a href="https://www.youtube.com/watch?v=Y-x0efG1seA" class="btn-video popup-youtube"><i class="fas fa-play-circle"></i> Watch Video</a>
							</figure>
						</div>						
					</div>	
					<!-- About Image End -->				
				...
				<div class="col-lg-6">
					...
					<div class="about-content">
						<!-- Section Title Start -->
						<div class="section-title">
							<h3 class="wow fadeInUp">about medicalife</h3>
							<h2 class="text-anime-style-3">Our Best Services & Poplular Treatment Here.</h2>
						</div>
						<!-- Section Title End -->

						<!-- About Content Body Start -->
						<div class="about-content-body">
							<p class="wow fadeInUp">we take pride in offering a wide range of best-in-class medical services and popular treatments to cater to your diverse healthcare needs .</p>
						</div>
						...
						<div class="about-content-footer">
							...
							<a href="about.php" class="btn-default wow fadeInUp" data-wow-delay="0.5s">read more</a>
						</div>
				...
				<div class="col-lg-4 col-md-4">
					<div class="medical-service-heading">
						...
						<div class="section-title">
							...
							<h2 class="text-anime-style-3">We're Providing Best Services.</h2>
						</div>
						<!-- Section Title End -->
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4">
					...
					<div class="medical-service-item wow fadeInUp">
						<div class="medical-service-content">
							<!-- Icon Box Start -->
							<div class="icon-box">
								<img src="assets/images/icon-medical-service-1.svg" alt="">
							</div>
							<!-- Icon Box End -->
							...
							<div class="medical-content">
								<h3>eye care</h3>
								<p>we understand the importance of clear vision and its impact on your.</p>
							</div>
							<!-- Medical Content End -->
						</div>
						<!-- Medical Service Button Start -->
						<div class="medical-service-btn">
							<a href="services.php" class="btn-services">read more <i class="far fa-arrow-alt-circle-right"></i></a>
						</div>
				...
				<div class="col-lg-4 col-md-4">
					...
					<div class="medical-service-item wow fadeInUp" data-wow-delay="0.25s">
						<div class="medical-service-content">
							<!-- Icon Box Start -->
							<div class="icon-box">
								<img src="assets/images/icon-medical-service-2.svg" alt="">
							</div>
							<!-- Icon Box End -->
				...
				<div class="col-lg-4 col-md-4">
					...
					<div class="medical-service-item wow fadeInUp" data-wow-delay="0.5s">
						<div class="medical-service-content">
							<!-- Icon Box Start -->
							<div class="icon-box">
								<img src="assets/images/icon-medical-service-3.svg" alt="">
							</div>
							<!-- Icon Box End -->
				...
				<div class="col-lg-4 col-md-4">
					...
					<div class="medical-service-item wow fadeInUp" data-wow-delay="0.75s">
						<div class="medical-service-content">
							<!-- Icon Box Start -->
							<div class="icon-box">
								<img src="assets/images/icon-medical-service-4.svg" alt="">
							</div>
							<!-- Icon Box End -->
				...
				<div class="col-lg-4 col-md-4">
					...
					<div class="medical-service-item wow fadeInUp" data-wow-delay="1s">
						<div class="medical-service-content">
							<!-- Icon Box Start -->
							<div class="icon-box">
								<img src="assets/images/icon-medical-service-5.svg" alt="">
							</div>
							<!-- Icon Box End -->
							...
							<div class="medical-content">
								...
								<p>hospitals, or clinics with positive reviews and ratings from patients.</p>
							</div>
							<!-- Medical Content End -->
						</div>
						<!-- Medical Service Button Start -->
			...
			<div class="row section-row align-items-center">
				<div class="col-md-6">
					...
					<div class="section-title">
						...
						<h2 class="text-anime-style-3">A Comprehensive Directory For Your Health Care.</h2>
					</div>
					<!-- Section Title End -->
				</div>
				...
				<div class="col-md-6">
					<div class="section-title-content wow fadeInUp">
						<p>we are your trusted one-stop destination for all your healthcare needs. Our comprehensive directory is designed to provide you with easy access to a wide range of healthcare services and providers, ensuring that you and your family.</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-3 col-6">
					...
					<div class="work-step-item wow fadeInUp">
						<!-- Icon Box Start -->
						<div class="icon-box">
							<img src="assets/images/icon-work-step-1.svg" alt="">
						</div>
						<!-- Icon Box End -->
				...
				<div class="col-md-3 col-6">
					...
					<div class="work-step-item wow fadeInUp" data-wow-delay="0.5s">
						<!-- Icon Box Start -->
						<div class="icon-box">
							<img src="assets/images/icon-work-step-2.svg" alt="">
						</div>
						<!-- Icon Box End -->
				...
				<div class="col-md-3 col-6">
					...
					<div class="work-step-item wow fadeInUp" data-wow-delay="0.75s">
						<!-- Icon Box Start -->
						<div class="icon-box">
							<img src="assets/images/icon-work-step-3.svg" alt="">
						</div>
						<!-- Icon Box End -->
				...
				<div class="col-md-3 col-6">
					...
					<div class="work-step-item wow fadeInUp" data-wow-delay="1s">
						<!-- Icon Box Start -->
						<div class="icon-box">
							<img src="assets/images/icon-work-step-4.svg" alt="">
						</div>
						<!-- Icon Box End -->
					...
					<div class="faq-counter-image">
						...
						<div class="faq-image">
							<figure class="reveal image-anime">
								<img src="assets/images/home-faq-img.jpg" alt="">
							</figure>
						</div>
						<!-- Image Item End -->
				...
				<div class="col-lg-6">
					<div class="faqs-content">
						...
						<div class="section-title">
							...
							<h2 class="text-anime-style-3">Consultations with Qualified doctors.</h2>
						</div>
					<!-- Section Title End -->
