...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            ...
            <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>MeCare</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="feedback.php" class="nav-item nav-link mb-5 active"><i class="fas fa-comment me-2"></i>Feedbacks</a>
