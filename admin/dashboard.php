        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="dashboard.php" class="nav-item nav-link active"><i class="fas fa-columns me-2"></i>Dashboard</a>
                    ...
                    <a href="feedback-management.php" class="nav-item nav-link"><i class="fas fa-comments me-2"></i>Feedback Management</a>
        ...
        <div class="col-md-6">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <a href="./all-appointments.php" class="btn btn-primary">View Details</a>
                </div>
            </div>
        </div>
    </div>
