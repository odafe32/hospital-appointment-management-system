                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="./new-appointments.php" class="nav-item nav-link active"><i class="fas fa-calendar-check me-2"></i>New Appointments</a>
...
<div class="container mt-5">
    ...
    <h2 class="mb-4">New appointments</h2>
    <div class="row">
...
$pending_appt = mysqli_query($connect,"SELECT * FROM `appointment` INNER JOIN `student` ON appointment.student_id = student.student_id WHERE appointment_status = 'PENDING'");
                ...
                while ($pending_appt_fetch = mysqli_fetch_assoc($pending_appt)) {
                    ...
                    <td>'.$patient_firstname . " " . $patient_lastname . " " . $patient_othername.' </td>
                        ...
                        <td>
                            <a href="approve-appointment.php?appointment_id='. $appointment_id .'" class="btn btn-primary mx-3">Approve</a>
                            <a href="decline-appointment.php?appointment_id='. $appointment_id .'" class="btn btn-danger">Reject</a>
                        </td>
