...
<body>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="./approved-appointments.php" class="nav-item nav-link active"><i class="fas fa-check-circle me-2"></i>Approved Appointments</a>
    ...
    <h2 class="mb-4">Approved appointments</h2>
    <div class="row">
