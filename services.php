...
<head>
	...
	<!-- Page Title -->
	<title>Services | MediPro - Hospital  Management</title>
	<!-- Favicon Icon -->
...
<body class="tt-magic-cursor">
	...
	<div class="preloader">
		<div class="loading-container">
			...
			<div id="loading-icon"><img src="assets/assets/images/loader.svg" alt=""></div>
		</div>
	</div>
	<!-- Preloader End -->
				...
				<div class="container">
					...
					<div class="header-logo">
						<a class="navbar-brand" href="#">
							<img src="assets/assets/assets/assets/images/logo.svg" alt="">
						</a>
					</div>
					<!-- Logo End -->
					...
					<div class="collapse navbar-collapse main-menu">
                        <div class="nav-menu-wrapper">
                            <ul class="navbar-nav mr-auto" id="menu">
                                ...
                                <li class="nav-item highlighted-menu"><a class="nav-link" href="signin.php">Book Appointment <i class="fa-solid fa-calendar-days"></i></a></li>
                            </ul>
                        </div>
					</div>
					<!-- Main Menu End -->
            ...
            <div class="row section-row">
                <div class="col-md-12">
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3">Providing Medical Care For TheSickest In Our Community.</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="our-services-item wow fadeInUp">
                        <div class="service-item-image">
                            <img src="assets/images/icon-service-page-1.svg" alt="">
                        </div>
                        <div class="services-item-content">
                            <h3>cardiology clinic</h3>
                            <p>Expert consultations with board-certified cardiologists to assess heart health, discuss symptoms, and develop personalized treatment.</p>
                            <ul>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="our-services-item wow fadeInUp" data-wow-delay="0.25s">
                        <div class="service-item-image">
                            <img src="assets/images/icon-service-page-2.svg" alt="">
                        </div>
                        <div class="services-item-content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="our-services-item wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item-image">
                            <img src="assets/images/icon-service-page-3.svg" alt="">
                        </div>
                        <div class="services-item-content">
                            <h3>laboratory analysis</h3>
                            <p>Our Laboratory Analysis Services offer a comprehensive range of advanced tests to aid in the accurate diagnosis. metabolic disorders.</p>
                            <ul>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="our-services-item wow fadeInUp" data-wow-delay="0.75s">
                        <div class="service-item-image">
                            <img src="assets/images/icon-service-page-4.svg" alt="">
                        </div>
                        <div class="services-item-content">
                            <h3>pediatric clinic</h3>
                            <p>Comprehensive well-child checkups, growth monitoring, and developmental assessments to ensure your child's health track.</p>
                            <ul>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="our-services-item wow fadeInUp" data-wow-delay="1s">
                        <div class="service-item-image">
                            <img src="assets/images/icon-service-page-5.svg" alt="">
                        </div>
                        <div class="services-item-content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="our-services-item wow fadeInUp" data-wow-delay="1.25s">
                        <div class="service-item-image">
                            <img src="assets/images/icon-service-page-6.svg" alt="">
                        </div>
                        <div class="services-item-content">
            ...
            <div class="row">   
                <div class="col-md-3 col-6">
                    ...
                    <div class="specialist-item wow fadeInUp">
                        <div class="icon-box">
                            <img src="assets/images/icon-specialist-1.svg" alt="">
                        </div>
                        <div class="specialist-content">
                            <h3>cardiology</h3>
                            <a><i class="fas fa-arrow-alt-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- Specialist Item End -->
                </div>
                ...
                <div class="col-md-3 col-6">
                    ...
                    <div class="specialist-item wow fadeInUp" data-wow-delay="0.25s">
                        <div class="icon-box">
                            <img src="assets/images/icon-specialist-2.svg" alt="">
                        </div>
                        <div class="specialist-content">
                            <h3>diagnostics</h3>
                            <a><i class="fas fa-arrow-alt-circle-up"></i></a>
                        </div>
                    </div>
                    <!-- Specialist Item End -->
                </div>
                ...
                <div class="col-md-3 col-6">
                    ...
                    <div class="specialist-item wow fadeInUp" data-wow-delay="0.5s">
                        <div class="icon-box">
                            <img src="assets/images/icon-specialist-3.svg" alt="">
                        </div>
                        <div class="specialist-content">
                            <h3>virology</h3>
                ...
                <div class="col-md-3 col-6">
                    ...
                    <div class="specialist-item wow fadeInUp" data-wow-delay="0.75s">
                        <div class="icon-box">
                            <img src="assets/images/icon-specialist-4.svg" alt="">
                        </div>
                        <div class="specialist-content">
                            <h3>therapy</h3>
                            <a><i class="fas fa-arrow-alt-circle-left"></i></a>
                        </div>
                    </div>
                    <!-- Specialist Item End -->
                </div>
    ...
    <!-- Meet Our Team Start -->
    <div class="meet-our-team service-team">
        <div class="container">
            <div class="row">
                    ...
                    <div class="team-member-item wow fadeInUp">
                        ...
                        <div class="team-body">
                            <div class="team-content">
                                ...
                                <h2><a href="#">dr. elizabeth foster</a></h2>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="team-member-item wow fadeInUp" data-wow-delay="0.75s">
                        ...
                        <div class="team-body">
                            <div class="team-content">
                                <h3>dermatologist</h3>
                                <h2><a href="#">dr. daniel brown</a></h2>
                ...
                <div class="culture-image-gallery wow fadeInUp">
                    <div class="caulture-img">
                        <div class="photo-gallery">
                            <a href="assets/images/cultuer-1.jpg"><img src="assets/images/cultuer-1.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="caulture-img">
                        <div class="photo-gallery">
                            <a href="assets/images/cultuer-2.jpg"><img src="assets/images/cultuer-2.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="caulture-img">
                        <div class="photo-gallery">
                            <a href="assets/images/cultuer-3.jpg"><img src="assets/images/cultuer-3.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="caulture-img">
                        <div class="photo-gallery">
                            <a href="assets/images/cultuer-4.jpg"><img src="assets/images/cultuer-4.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="caulture-img">
                        <div class="photo-gallery">
                            <a href="assets/images/cultuer-5.jpg"><img src="assets/images/cultuer-5.jpg" alt=""></a>
                        </div>
                    </div>

                    <div class="caulture-img">
                        <div class="photo-gallery">
                            <a href="assets/images/cultuer-6.jpg"><img src="assets/images/cultuer-6.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="caulture-img">
                        <div class="photo-gallery">
                            <a href="assets/images/cultuer-7.jpg"><img src="assets/images/cultuer-7.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="caulture-img">
                        <div class="photo-gallery">
                            <a href="assets/images/cultuer-8.jpg"><img src="assets/images/cultuer-8.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="caulture-img">
                        <div class="photo-gallery"> 
                            <a href="assets/images/cultuer-9.jpg"><img src="assets/images/cultuer-9.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="caulture-img">
                        <div class="photo-gallery"> 
                            <a href="assets/images/cultuer-10.jpg"><img src="assets/images/cultuer-10.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="download-apps">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-7 order-lg-1 order-md-1 order-2">
                    <!-- Download Apps Description Start -->
                    <div class="download-apps-description">
                        <!-- Section Title Start -->
                        <div class="section-title">
                            <h3 class="wow fadeInUp">app download</h3>
                            <h2 class="text-anime-style-3">Download MediPro App & Get 100$ Healthcase.</h2>
                        </div>
                        <!-- Section Title End -->

                        <!-- Download Apps Body Start -->
                        <div class="download-apps-body">
                            <p class="wow fadeInUp">Welcome to the convenient world of our Medical Website App, where taking control of your health has never been easier. Download our user-friendly app now to access a wide range of medical services and resources right at your fingertips.</p>
                        </div>
                        <!-- Download Apps Body End -->

                        <!-- Download Apps Footer Start -->
                        <div class="download-apps-footer wow fadeInUp" data-wow-delay="0.25s">
                            <div class="download-apps-image">
                                <a href="#"><img src="assets/images/google-play-img.png" alt=""></a>
                            </div>
                            <div class="download-apps-image">
                                <a href="#"><img src="assets/images/app-store-img.png" alt=""></a>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-md-5 order-lg-2 order-md-2 order-1">
                    <!-- Download Apps Image Start -->
                    <div class="download-apps-img">
                        <figure>
